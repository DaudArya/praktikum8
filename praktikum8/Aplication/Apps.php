            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Formulir Registrasi Siswa</h2>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th>NISN</th>"; //memberikan judul pada tabel NISN
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['nama'] . "</td>"; //memanggil nama user yang telah ada di database
                                        echo "<td>" . $row['nisn'] . "</td>"; //memanggil nisn user yang telah ada didatabse

                                        echo "<td>";
                                            echo "<a href='Read.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                                            //menampilkan icon read untuk membaca data yang telah di input
